<template>
    <div class="blog" v-if="blog">
        <div class="block" @click.right="openContextMenu([$event, 'blog:edit'])">
            ...
            <main>
                ...
                <ul class="links">
                    <li v-for="(link, idx) of blog?.links" :key="(link, idx)"
                        @click.right="openContextMenu([$event, `blog:link:edit:${idx}`])"
                ...
                <div class="content" @click.right="openContextMenu([$event, 'blog:content:edit'])">
